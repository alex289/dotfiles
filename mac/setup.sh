...
brew install git node neovim bat exa gnupg pinentry-mac ripgrep wget tmux zoxide neofetch k9s atuin lazygit yazi ffmpegthumbnailer unar jq poppler fd fzf tokei jandedobbeleer/oh-my-posh/oh-my-posh
